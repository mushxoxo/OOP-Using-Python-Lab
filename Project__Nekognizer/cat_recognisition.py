...
def load_dataset():
    with h5py.File("data.h5", "r") as dataset:
        train_set_x_orig = np.array(dataset["train_set_x"][:])  # training set features
        train_set_y = np.array(dataset["train_set_y"][:])       # training set labels
        test_set_x_orig = np.array(dataset["test_set_x"][:])    # test set features
        test_set_y = np.array(dataset["test_set_y"][:])         # test set labels
        classes = np.array(dataset["list_classes"][:])          # list of classes
